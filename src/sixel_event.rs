...
impl SixelEvent {
    pub fn new_dcs(macro_parameter: Option<u8>, inverse_background: Option<u8>, horizontal_pixel_distance: Option<usize>) -> SixelEvent {
        SixelEvent::Dcs { macro_parameter, inverse_background, horizontal_pixel_distance }
    }
    pub fn new_color_introducer(color_number: u8, coordinate_system_indicator: Option<u8>, x: Option<usize>, y: Option<usize>, z: Option<usize>) -> Result<SixelEvent, ParserError> {
            ...
            (
                ...
                let event = SixelEvent::ColorIntroducer {
                    ...
                    color_coordinate_system: Some(
                        ColorCoordinateSystem::new(coordinate_system_indicator, x, y, z)?
                    ),
                };
                Ok(event)
            }
...
impl ColorCoordinateSystem {
    pub fn new(coordinate_system_indicator: u8, x: usize, y: usize, z: usize) -> Result<Self, ParserError> {
